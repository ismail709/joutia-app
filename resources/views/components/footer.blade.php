    ...
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <p class="text-gray-400">Your trusted platform for seamless shopping and selling experiences.</p>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    @foreach ($categories as $category)
                        <li>
                            <a class="capitalize text-gray-400 hover:text-white transition" href="{{ route('categories.show', $category->id) }}">
                                {{ $category->name }}
                            </a>
                        </li>
                    @endforeach
        ...
        <div class="mt-8 pt-8 border-t border-gray-700 text-center">
            <p class="text-gray-400">&copy; 2025 Joutia. All rights reserved.</p>
        </div>
    </div>
</footer>